            ...
            if (src != '') {
                jQuery("<img>").load(function () {
                    if (wc_pos_params.use_passprint) {
                        var passprnt_url = "starpassprnt://v1/print/nopreview?size=" + wc_pos_params.passprint_size + "&back=http://webprnt.com/demofiles/PassPRNT/PassPRNT.html&html=<!DOCTYPE html>" + newHTML.html();
                        location.href = encodeURI(passprnt_url);
                    } else {
                        window.print();
                    }
                ...
                if (wc_pos_params.use_passprint) {
                    var passprnt_url = "starpassprnt://v1/print/nopreview?size=" + wc_pos_params.passprint_size + "&back=http://webprnt.com/demofiles/PassPRNT/PassPRNT.html&html=" + newHTML.html();
                    location.href = encodeURI(passprnt_url);
                } else {
                    window.print();
                }
