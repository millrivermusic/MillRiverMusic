...
$options = array(
	'products' => array(
		...
		'type'    => 'tab',
		'options' => array(
			'general-products-box' => array(
				'title'   => __( 'General Options', 'the-core' ),
				'type'    => 'box',
				'options' => array(
					'general_products_options' => array(
						'type'          => 'multi',
						'label'         => false,
						'attr'          => array(
						...
						'inner-options' => array(
							'product_gallery_group' => array(
								'type' => 'group',
								'attr' => array('class' => 'border-bottom-none'),
								'options' => array(
									'product_gallery' => array(
										'label'   => __( 'Product Image Gallery', 'the-core' ),
										'desc'    => __( 'Select the image gallery type', 'the-core' ),
										'help'    => __( 'The image gallery is displayed on the product details page.', 'the-core' ),
										'type'    => 'radio',
										'attr'    => array('class' => 'fw-checkbox-float-left'),
										'value'   => 'lightbox',
										'choices' => array(
											'lightbox' => __( 'Light Box', 'the-core' ),
											'slider'   => __( 'Slider', 'the-core' ),
										),
									),
									'product_zoom' => array(
										'type'  => 'switch',
										'value' => 'yes',
										'label' => __('Image Zoom', 'the-core'),
										'desc'  => __('Enable gallery image zoom on hover?', 'the-core'),
										'left-choice' => array(
											'value' => 'no',
