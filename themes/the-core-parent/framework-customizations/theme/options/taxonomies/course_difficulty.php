...
$options = array(
	...
	'header_image'                  => array(
		...
		'help'  => __( 'You can set a default header image for all your blog categories and post from the Theme Settings page under the', 'the-core' ) . ' <a target="_blank" href="' . $the_core_admin_url . 'themes.php?page=fw-settings#fw-options-tab-posts">' . __( 'Posts tab', 'the-core' ) . '</a>',
		'type'  => 'upload',
		'value' => '',
	),
