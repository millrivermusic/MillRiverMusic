...
$options   = array(
	...
	'header_image' => array(
		...
		'help'  => __( 'You can set a default header image for all your event categories and event post from the Theme Settings page under the', 'the-core' ) . ' <a target="_blank" href="' . $the_core_admin_url . 'themes.php?page=fw-settings&_focus_tab=fw-options-tab-events-posts#fw-options-tab-posts">' . __( 'Events tab', 'the-core' ) . '</a>',
		'type'  => 'upload',
		'value' => '',
	),
