...
$options = array(
	'learning-posts' => array(
		'title'   => __( 'Lessons', 'the-core' ),
		'type'    => 'tab',
		'options' => array(
			'header-learning-box' => array(
				'title'   => __( 'Single Lessons Header', 'the-core' ),
				'type'    => 'box',
				'options' => array(
					'general_learning_header' => array(
						'type'          => 'multi',
						'label'         => false,
						'attr'          => array(
						...
						'inner-options' => array(
							...
							'posts_header_image'           => array(
								...
								'help'  => __( "This default header image will be used for all your learning posts if you didn't set one for a specific learning post.", "the-core" ),
								'type'  => 'upload'
							),
							...
							'posts_header_title'           => array(
								...
								'picker'  => array(
									'posts_title' => array(
										...
										'desc'    => __( 'Select what title will be displayed in the learning posts header', 'the-core' ),
										'help'    => __( 'This title appears only on the learning detail page and will be displayed if you have a header image set (in the learning or here)', 'the-core' ),
								...
								'choices' => array(
									...
									'custom_title'   => array(
										'header_title_typography' => array(
											'attr'          => array(
												'data-advanced-for' => 'lessons_header_title_advanced_styling',
										...
										'custom_title_text'            => array(
											'attr'  => array( 'class' => 'lessons_header_title_advanced_styling' ),
										...
										'header_subtitle_typography' => array(
											'attr'          => array(
												'data-advanced-for' => 'lessons_header_subtitle_advanced_styling',
												'class'             => 'fw-advanced-button'
											),
											'type'          => 'popup',
											'label'         => __( 'Custom Style', 'the-core' ),
										...
										'custom_subtitle_text'         => array(
											'attr'  => array( 'class' => 'lessons_header_subtitle_advanced_styling' ),
